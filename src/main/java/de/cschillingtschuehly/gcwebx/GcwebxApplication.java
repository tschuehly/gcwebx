...
public class GcwebxApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception{
		...
		contentRepository.save(new Content(3, "Synergy steigt ab", "<p>Nach dem spannenden Match gegen Silentpeak ist für Synergy der Abstieg in die Necomer league besiegelt.</p>", true, LocalDateTime.parse("2020-07-02T10:54:48.283"),  LocalDateTime.parse("2020-07-02T11:23:56.135")));
		contentRepository.save(new Content(4, "Welcome Zero214", "<p>Ein neuer <em>Streamer</em> wagt sich an die Xperience Community ran!!</p>", true, LocalDateTime.parse("2020-07-02T10:44:38.283"),  LocalDateTime.parse("2020-07-02T11:22:54.135")));
