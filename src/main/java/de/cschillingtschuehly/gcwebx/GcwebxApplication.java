...
*/
		...
		memberRepository.save(new Member(2L,"T0XIC_BABE","test1",LocalDate.of(2000,06,21),LocalDate.of(2019,11,02), new URL("https://twitter.com/Thaiminater"),new URL("https://www.youtube.com/channel/UCF_1TbJprVWT6SsyqSEJ_Qg"),"thermite.jpg"));
		...
		memberRepository.save(new Member(5L,"Sucuk","test1",LocalDate.of(2000,06,21),LocalDate.of(2019,11,02), new URL("https://twitter.com/Thaiminater"),new URL("https://www.youtube.com/channel/UCF_1TbJprVWT6SsyqSEJ_Qg"),"sledge.jpg"));
